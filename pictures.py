...
full_heart = pg.image.load("test/pictures/full_heart.png").convert_alpha()
full_heart = pg.transform.scale(full_heart, (40, 40))

empty_heart = pg.image.load("test/pictures/empty_heart.png").convert_alpha()
empty_heart = pg.transform.scale(empty_heart, (40, 40))

#cracked_heart = pg.image.load("test/pictures/cracked_heart.png").convert_alpha()
#cracked_heart = pg.transform.scale(cracked_heart, (40, 40))

#shield_heart = pg.image.load("test/pictures/shield_heart.png").convert_alpha()
#shield_heart = pg.transform.scale(shield_heart, (40, 40))

sort_up = pg.image.load("test/pictures/sort_up.png").convert_alpha()
sort_up = pg.transform.scale(sort_up, (40, 40))

sort_down = pg.image.load("test/pictures/sort_down.png").convert_alpha()
sort_down = pg.transform.scale(sort_down, (40, 40))


sort_up_gray = pg.image.load("test/pictures/sort_up_gray.png").convert_alpha()
sort_up_gray = pg.transform.scale(sort_up_gray, (40, 40))

sort_down_gray = pg.image.load("test/pictures/sort_down_gray.png").convert_alpha()
